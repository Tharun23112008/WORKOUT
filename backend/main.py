    ...
    try:
        ...
        if SMTP_PASSWORD:
            try:
                ...
                img_part.add_header("Content-Disposition", "attachment", filename=f"payment_{quiz_id[:8]}.jpg")
                msg.attach(img_part)
