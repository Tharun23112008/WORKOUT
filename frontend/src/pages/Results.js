        ...
        {showPaymentModal && (
          ...
          >
            <motion.div
              ...
              className="glass-morphism-strong rounded-3xl p-10 max-w-2xl w-full relative overflow-hidden"
            >
              {/* Close Button */}
              <button
                onClick={() => setShowPaymentModal(false)}
                className="absolute top-6 right-6 glass-morphism p-2 rounded-full hover:glass-morphism-strong transition-all"
              >
